...
#include "../PgnParser/Bitboard.hpp"

using namespace m8db;

TEST_CASE("RookAttacksEmptyBoard")
{
   Bitboard occ = 0;
   ...
   REQUIRE(expected_attacks == attacks);
}

TEST_CASE("RookAttacksSommeOccupiedSquares")
{
   Position rook_position = 27; // d4
...
TEST_CASE("BishopAttacksEmptyBoard")
{
   Bitboard occ = 0;
...
TEST_CASE("BishopAttacksSommeOccupiedSquares")
{
   Position bishop_position = 27; // d4
